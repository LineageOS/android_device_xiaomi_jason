...
public class IFAAManagerImpl extends IFAAManagerV3 {
    ...
    private static final String mFingerActName = "com.android.settings.Settings$SecuritySettingsActivity";
    ...
    public int startBIOManager(Context context, int authType) {
        ...
        if (authType == IFAA_TYPE_FINGER) {
            ...
            intent.setComponent(new ComponentName(mFingerPackName, mFingerActName));
